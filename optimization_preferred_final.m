...
f = zeros(1,23);  %in order of x1, x2, x3
...
f  = [80 60 120 80 160 240 320      60 30 80     240 80 240            80 160 80     320 80 240 40 240 80 240];

%Aineq coefficient matrix and bineq vector
%first constraint %Atlanta monthly production constraint
...
%second constraint
%Charlotte monthly production constraint
Aineq(2,8) = 1;
Aineq(2,9) = 1;
Aineq(2,10) = 1;
%Aineq(2,12) = 1;
...
%third constraint
%(Birmingham maximum monthly throughput)
Aineq(3,1) = 1;
bineq(3,1) = 70000;

%fourth constraint
%(Greenville maximum monthly throughput)
Aineq(4,2) = 1;
Aineq(4,8) = 1;
bineq(4,1) = 50000;

%fifth constraint
%(Gastonia maximum monthly throughput)
Aineq(5,3) = 1;
Aineq(5,9) = 1;
bineq(5,1) = 100000;

%sixth constraint
%(Augusta maximum monthly throughput)
Aineq(6,4) = 1;
Aineq(6,10) = 1;
bineq(6,1) = 40000;
...
%first constraint
%(Input Output balance of birmingham warehouse)
Aeq(1,1) = 1;
Aeq(1,11) = -1;
Aeq(1,12) = -1;
Aeq(1,13) = -1;
...
%second constraint
%(Input Output balance of Greenville warehouse)
Aeq(2,2) = 1;
Aeq(2,8) = 1;
Aeq(2,14) = -1;
Aeq(2,15) = -1;
...
%third constraint
%(Input Output balance of Gastonia ware-house)
Aeq(3,3) = 1;
Aeq(3,9) = 1;
Aeq(3,17) = -1;
Aeq(3,18) = -1;
...
%fourth constraint
%(Input Output balance of Augusta ware-house)
Aeq(4,4) = 1;
Aeq(4,10) = 1;
Aeq(4,20) = -1;
Aeq(4,21) = -1;
